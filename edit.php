      ...
      <form action="" method="post" style="width: 55vw; min-width: 350px">
        ...
        <div class="row form-group mb-3">
          <div class="col-12">
            ...
            <input type="radio" class="form-check-input" name="gender" id="male" value="male" <?php echo ($row['gender'] === 'mail') ? "checked" : "" ?>>
            <label for="male" class="form-input-label">Male</label>&nbsp;
            <input type="radio" class="form-check-input" name="gender" id="female" value="female" <?php echo ($row['gender'] === 'femail') ? "checked" : "" ?>>
